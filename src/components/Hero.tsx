...
export default function Hero({ onSearch, activeQuery }: HeroProps) {
  ...
  return (
    <div className="relative h-[80vh] md:h-[85vh] w-full flex items-center justify-center overflow-hidden bg-slate-950 font-sans" id="hero-section">
      ...
      <div className="relative z-10 w-full max-w-6xl px-6 md:px-12 flex flex-col items-center justify-center text-center">
        ...
        <motion.h1 
          ...
          className="text-4xl md:text-6xl font-serif text-white tracking-tight leading-[1.1] max-w-3xl mb-6"
          id="hero-title"
        >
          ...
          <div ref={destRef} className="relative flex-1 group" id="search-dest-container">
            ...
            >
              ...
              <input 
                ...
                className="bg-transparent text-sm font-medium text-white placeholder-slate-500 w-full focus:outline-none select-none"
              />
            </div>
              ...
              {activeDropdown === "dates" && (
                ...
                >
                  <div className="flex items-center justify-between mb-4 pb-2 border-b border-slate-800">
                    <div className="text-sm font-mono text-white">Select Dates (Summer 2026)</div>
                    <button 
                      onClick={() => setQuery({ ...query, startDate: null, endDate: null })}
                      className="text-xs text-slate-500 hover:text-white transition-colors underline decoration-slate-600 underline-offset-2"
                    >
                      Clear dates
                    </button>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    {/* June 2026 */}
                    <div>
                      <div className="text-xs font-semibold text-white tracking-widest uppercase mb-3 text-center">June 2026</div>
                    ...
                    {/* July 2026 */}
                    <div>
                      <div className="text-xs font-semibold text-white tracking-widest uppercase mb-3 text-center">July 2026</div>
                      <div className="grid grid-cols-7 gap-1 text-center text-[10px] font-mono text-slate-500 mb-2 uppercase">
                        <div>Su</div><div>Mo</div><div>Tu</div><div>We</div><div>Th</div><div>Fr</div><div>Sa</div>
                      </div>
                      <div className="grid grid-cols-7 gap-1">
                  ...
                  <div className="mt-5 flex items-center justify-between pt-3 border-t border-slate-800/80 text-[11px] text-slate-400">
                    ...
                    <button
                      ...
                      className="bg-slate-800 hover:bg-slate-700 text-white font-medium py-1.5 px-3 rounded-lg transition-colors duration-150"
                    >
                      Confirm Dates
                    </button>
                  </div>
                ...
                >
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <div className="text-sm font-medium text-white">Adults</div>
                      ...
                      <div className="flex items-center gap-3">
                        <button 
                          ...
                          className="w-8 h-8 rounded-lg border border-slate-700 flex items-center justify-center text-slate-400 hover:border-white hover:text-white transition-colors"
                        >
                          <Minus size={14} />
                        </button>
                        <span className="text-sm font-mono font-medium text-white w-6 text-center">{query.guests.adults}</span>
                        <button 
                          type="button"
                          onClick={() => setQuery({
                            ...query,
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm font-mono font-medium text-white w-6 text-center">{query.guests.children}</span>
                        <button 
                          type="button"
                          onClick={() => setQuery({
                            ...query,
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <div className="text-sm font-medium text-white">Pavilions / Rooms</div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm font-mono font-medium text-white w-6 text-center">{query.guests.rooms}</span>
                        <button 
                          type="button"
                          onClick={() => setQuery({
                            ...query,
