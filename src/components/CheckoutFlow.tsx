...
export default function CheckoutFlow({
  ...
  return (
    <div className="bg-slate-950 text-slate-100 py-6 px-4 md:px-12 max-w-7xl mx-auto font-sans" id="checkout-flow-module">
      ...
      {step === 3 ? (
        ...
        >
          ...
          <div className="space-y-3">
            ...
            <h2 className="text-3xl font-serif text-white">Your Retreat is Prepared</h2>
            <p className="text-xs text-slate-400 font-light max-w-md mx-auto leading-relaxed">
              An editorial confirmation voucher has been transmitted to <span className="text-white font-medium">{booking.guestDetails.email}</span>. Your personal butler has been notified of your premium preferences.
            </p>
          </div>
          ...
          <div className="bg-slate-950 border border-slate-900 rounded-2xl p-6 text-left space-y-6 shadow-xl relative" id="receipt-voucher-card">
            ...
            <div className="flex justify-between items-start border-b border-slate-900 pb-4">
              <div>
                ...
                <h4 className="text-base font-serif text-white font-semibold mt-0.5">{property.name}</h4>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6 text-xs border-b border-slate-900 pb-6 font-mono">
              <div>
                ...
                <span className="text-white font-sans font-medium block mt-1">{room.name}</span>
              </div>
              <div>
                <span className="text-slate-500 block uppercase text-[10px]">Dates of stay</span>
                <span className="text-white font-medium block mt-1">{formatDate(booking.startDate)} - {formatDate(booking.endDate)}</span>
              </div>
              <div>
                <span className="text-slate-500 block uppercase text-[10px]">Accommodations</span>
                <span className="text-white font-medium block mt-1">{booking.guests.adults} Adults, {booking.guests.rooms} Room</span>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-8 space-y-8">
            {step === 1 ? (
              ...
              >
                <div>
                  <h3 className="text-xl font-serif text-white mb-2">Guest Profile</h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-xs">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full bg-slate-900 border ${formErrors.firstName ? "border-rose-500" : "border-slate-800 focus:border-slate-600"} p-3 rounded-xl text-white outline-none font-sans`}
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full bg-slate-900 border ${formErrors.lastName ? "border-rose-500" : "border-slate-800 focus:border-slate-600"} p-3 rounded-xl text-white outline-none font-sans`}
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full bg-slate-900 border ${formErrors.email ? "border-rose-500" : "border-slate-800 focus:border-slate-600"} p-3 rounded-xl text-white outline-none font-sans`}
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full bg-slate-900 border ${formErrors.phone ? "border-rose-500" : "border-slate-800 focus:border-slate-600"} p-3 rounded-xl text-white outline-none font-sans`}
                    />
                ...
                <div className="pt-6 border-t border-slate-900 space-y-4">
                  <div>
                    <h4 className="text-sm font-mono text-white uppercase tracking-wider flex items-center gap-2">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="p-4 bg-slate-900/30 border border-slate-900 rounded-xl space-y-2">
                      ...
                      <select
                        ...
                        className="w-full bg-slate-950 border border-slate-850 p-2 rounded-lg text-xs text-white focus:outline-none focus:border-amber-500 font-sans"
                      >
                    ...
                    <div className="p-4 bg-slate-900/30 border border-slate-900 rounded-xl space-y-2">
                      ...
                      <input
                        ...
                        className="w-full bg-slate-950 border border-slate-850 p-2 rounded-lg text-xs text-white placeholder-slate-600 focus:outline-none focus:border-amber-500 font-sans"
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      <div>
                        <div className="text-xs font-semibold text-white">Private Luxury Airport Pick-up & Transfer</div>
                        <div className="text-[10px] text-slate-400 font-light mt-0.5">Private Tesla Model S or luxury speedboat transfers depending on property location (+ $250 flat fee)</div>
                      </div>
                    ...
                    >
                      <div>
                        <div className="text-xs font-semibold text-white">Bespoke 24/7 Personal Butler Access</div>
                        <div className="text-[10px] text-slate-400 font-light mt-0.5">A dedicated guild-certified professional assigned exclusively to your pavilion (+ $500 flat fee)</div>
                      </div>
              ...
              >
                <div>
                  <h3 className="text-xl font-serif text-white mb-2">Secure Guarantee</h3>
                ...
                <div className="relative w-full max-w-sm aspect-[1.6/1] bg-gradient-to-tr from-slate-900 to-slate-800 border border-slate-800 rounded-2xl p-6 flex flex-col justify-between shadow-2xl mx-auto md:mx-0 overflow-hidden group">
                  ...
                  {/* Card Number display */}
                  <div className="text-lg font-mono tracking-widest text-white/95 text-center my-4">
                  ...
                  <div className="flex justify-between text-[11px] font-mono">
                    <div>
                      ...
                      <span className="text-white uppercase truncate max-w-[180px] block mt-0.5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-xs pt-4 border-t border-slate-900">
                  <div className="col-span-1 sm:col-span-2">
                    ...
                    <input
                      ...
                      className={`w-full bg-slate-900 border ${formErrors.cardHolder ? "border-rose-500" : "border-slate-800 focus:border-slate-600"} p-3 rounded-xl text-white outline-none font-sans uppercase`}
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full bg-slate-900 border ${formErrors.cardNumber ? "border-rose-500" : "border-slate-800 focus:border-slate-600"} p-3 rounded-xl text-white outline-none font-mono`}
                    />
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full bg-slate-900 border ${formErrors.expiryDate ? "border-rose-500" : "border-slate-800 focus:border-slate-600"} p-3 rounded-xl text-white outline-none font-mono`}
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full bg-slate-900 border ${formErrors.cvv ? "border-rose-500" : "border-slate-800 focus:border-slate-600"} p-3 rounded-xl text-white outline-none font-mono`}
                      />
                ...
                <div className="pt-6 border-t border-slate-900 flex justify-between">
                  <button
                    onClick={() => setStep(1)}
                    className="py-3 px-6 bg-slate-900 border border-slate-800 hover:border-slate-700 text-slate-400 hover:text-white rounded-xl font-mono text-xs uppercase tracking-wider transition-colors flex items-center gap-2"
                  >
                    <ArrowLeft size={14} />
                    <span>Back</span>
                  </button>
          ...
          <div className="lg:col-span-4 bg-slate-900/60 border border-slate-850 rounded-2xl p-6" id="checkout-summary-widget">
            ...
            <div className="flex gap-4 items-center pb-4 border-b border-slate-800">
              ...
              />
              <div>
                <h4 className="text-sm font-serif text-white font-medium">{property.name}</h4>
            ...
            <div className="py-4 border-b border-slate-800 space-y-2 text-xs">
              <div className="flex justify-between items-center text-slate-400">
                ...
                <span className="text-white font-mono">{formatDate(booking.startDate)} - {formatDate(booking.endDate)}</span>
              </div>
              <div className="flex justify-between items-center text-slate-400">
              ...
              <div className="flex justify-between items-center text-slate-400">
                ...
                <span className="text-white font-mono">{nights} night{nights > 1 ? "s" : ""}</span>
              </div>
            </div>
            ...
            <div className="py-4 space-y-2.5 text-xs font-mono">
              ...
              <div className="flex justify-between text-slate-500">
                ...
                <span className="text-slate-300">${resortFee.toLocaleString()}</span>
              </div>

              <div className="flex justify-between text-slate-500">
                <span>Local eco-tax (10%)</span>
                <span className="text-slate-300">${localTax.toLocaleString()}</span>
              </div>

              <div className="flex justify-between text-white font-semibold pt-3 border-t border-slate-850 text-sm">
